 ...
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+-----------------+--------+--------|
 * |        | LGUI   | LALT   | FN     | LOWER  |      SPACE      |      ENTER      | RAISE  | RIGHT  | DOWN   | UP     |        |
 * '-----------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_BASE] = LAYOUT_ortho_hhkb(
  ...
  KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_PGUP, KC_ENT, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,  \
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_PGDN, KC_BSPC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
		   KC_LCTL, KC_LGUI, KC_LALT, LOWER,      KC_SPC,             KC_ENT,      RAISE,   KC_DOWN, KC_UP,   KC_RGHT  			\
 ),
 ...
 */
 ...
 [_LOWER] = LAYOUT_ortho_hhkb(
  KC_TILD, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_MINS,    KC_7,    KC_8,    KC_9, _______, _______, \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______,    KC_0,    KC_0, _______, _______, _______, \
             RESET, RGB_TOG, RGB_MOD, KC_TRNS,       KC_SPC,         KC_BSPC,      KC_TRNS, _______, _______, _______           \
 ),
 ...
 */
 ...
 [_RAISE] = LAYOUT_ortho_hhkb(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
           _______, _______, _______, KC_TRNS,       KC_SPC,          KC_ENT,      KC_TRNS, KC_VOLD, KC_VOLU, _______           \
 ),
